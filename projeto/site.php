...
use \brunotjuliani\Model\Address;
use \brunotjuliani\Model\User;
use \brunotjuliani\Model\Order;
use \brunotjuliani\Model\OrderStatus;
...
$app->post("/register", function() {
    ...
    if (!isset($_POST['name']) || $_POST['name'] == '') {
        User::setErrorRegister("Nome de usuário obrigatório.");
        header("Location: /login");
        exit;
    }
    if (!isset($_POST['email']) || $_POST['email'] == '') {
        User::setErrorRegister("E-mail obrigatório.");
        header("Location: /login");
        exit;
    }
    if (!isset($_POST['password']) || $_POST['password'] == '') {
        User::setErrorRegister("Senha obrigatória.");
        header("Location: /login");
        exit;
    }
...
$app->get("/boleto/:idorder", function($idorder) {
	...
	$dadosboleto["endereco2"] = $order->getdescity() . " - " . $order->getdesuf() . " - " . $order->getdescountry() .". " . "CEP: " . $order->getdeszipcode();

	// INFORMACOES PARA O CLIENTE
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja do Bruno";
	$dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
	$dadosboleto["demonstrativo3"] = "";
	$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
	$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: suporte@hcode.com.br";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja do Bruno - www.hcode.com.br";
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "Loja do Bruno";
